		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Timeline",
									"targetURL": "#yui5demokachain-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yui5demokachain-display": {
								"semanticObject": "yui5demokachain",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yui5demokachain",
									"url": sap.ui.require.toUrl("yui5demokachain")
								}
							}
						}
					}
